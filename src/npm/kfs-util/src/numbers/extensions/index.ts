...
/**
 * Calculates the least common devisor (LCD)
 * @param {number} a numerator
 * @param {number} b denominator
 * @returns {number} least common divisor
 */
export function lcd() {
    // TODO - future func
}
...
/**
 * Calculates the average (mean) value for a given array
 * @param {number[]} arr array of numbers
 * @returns {number | NaN} sum of all array numbers
...
/**
 * Finds the middle (median) value for a given array
 * @param {number[]} arr array of numbers
 * @returns {number | NaN} sum of all array numbers
...
/**
 * Finds the number with the most occurences (mode)
 * @param {number[]} arr array of numbers
 * @returns {number | NaN} sum of all array numbers
 * @example mode([1,2,5,2,3,4,2,6]) => 2
 */
export function mode(arr: number[]) {
    ...
    // count frequency of numbers in the array
